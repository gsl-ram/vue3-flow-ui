<template>
  <div class="code-editor-demo">
    <div class="demo-header">
      ...
      <p class="subtitle">
        Monaco-based code editor with line numbers and syntax highlighting. Supports
        JSON, EJS, Mustache, HTML, JavaScript, and plain text.
      </p>
    </div>
